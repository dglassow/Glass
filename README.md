...
### Everything running on all your computers, on whatever screen you're holding.

![The Glass app: AI assistants, rooms, and live sessions across four computers, with one session open](assets/glass.png)

Start it on the desktop. Close the lid. Pick it up on your phone an hour later,
still running, right where you left it.

### **[⬇ Download Glass 0.3.0 for Mac](../../releases/latest)**

Apple Silicon. Notarized by Apple. Drag to Applications and open it.
...
- **Carry it on your phone.** Installs like a normal app, with a clean chat view for your assistants.
...
**Today it's Apple Silicon Macs.** Linux is built and tested but not yet
released. The phone version is chat only.
